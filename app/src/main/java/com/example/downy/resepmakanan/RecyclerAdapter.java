package com.example.downy.resepmakanan;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerViewHolder> {
    ...
    String[] name = {"Kerang", "Kepiting", "Ikan Bakar", "Udang"};
    // menampilkan list item dalam bentuk text dengan tipe data string dengan variable name

    String[] deskripsi = {"Kerang manis", "Kepiting manis", "Ikan Bakar manis", "Udang manis"};
    Integer[] gambar = {R.drawable.ere, R.drawable.ewe, R.drawable.wiw, R.drawable.wow};
...
//member aksi saat cardview diklik berdasarkan posisi tertentu
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.recycletampilan, parent, false);
